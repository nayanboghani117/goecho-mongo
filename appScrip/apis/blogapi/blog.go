...
// ServeBlogResource sets up the routing of artist endpoints and the corresponding handlers.
...
// ServeBlogResourceWithAuth sets up the routing of artist endpoints and the corresponding handlers.
