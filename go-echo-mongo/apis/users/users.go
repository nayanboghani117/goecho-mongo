...
import (
	...
	"go-echo-mongo/go-echo-mongo/models"
	"go-echo-mongo/go-echo-mongo/doas/userDoas"
...
// @Router /users [post]
func Post(h *handler.Handler) echo.HandlerFunc {
...
// @Failure 500 {string} string "ok"
// @Router /users/{id} [put]
//func Put(h *handler.Handler) echo.HandlerFunc {
//
//	return func(c echo.Context) error {
//		id := c.Param("id")
...
//		if err := h.DB.UpdateId(u.ID,u); err != nil {
//			return err
//		}
//
...
//func Delete(h *handler.Handler) echo.HandlerFunc {
//	return func(c echo.Context) error {
//		id := c.Param("id")
//		if id == "" || !bson.IsObjectIdHex(id) {
//			return &echo.HTTPError{Code: http.StatusBadRequest, Message: "invalid ID"}
...
// @Failure 500 {string} string "ok"
// @Router /users/ [get]
//func Get(h *handler.Handler) echo.HandlerFunc {
//	return func(c echo.Context) error {
//		db := h.DB.Clone()
//		defer db.Close()
//		u := &model.Users{}
...
// @Failure 500 {string} string "ok"
// @Router /users/{id} [get]
//func GetOne(h *handler.Handler) echo.HandlerFunc{
//	return func(c echo.Context) error {
//		id := c.Param("id")
//		u := &model.User{}
//		if id == "" || !bson.IsObjectIdHex(id) {
...
// @Failure 500 {string} string "ok"
// @Router /login [get]
//func SignIn(h *handler.Handler) echo.HandlerFunc {
//
